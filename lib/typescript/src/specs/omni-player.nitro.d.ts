...
import type { CastStatus, OmniPlayerState, OmniPlayer as OmniPlayerT, PlayerBackend, PlayerStatus } from "../types/player";
import type { CastOptions, Source } from "../types/source";
export type NumberProperty = Exclude<keyof OmniPlayerState, "status" | "isPlaying" | "muted">;
export type BoolProperty = "isPlaying" | "muted" | "isAutoQuality";
export interface OmniEventMap extends HybridObject<{
    android: "kotlin";
}> {
    ...
    removeStateBoolListener(key: BoolProperty, cb: (value: boolean) => void): void;
...
export interface OmniPlayer extends HybridObject<{
    android: "kotlin";
}>, OmniPlayerT {
    readonly eventMap: OmniEventMap;
}
export interface OmniPlayerFactory extends HybridObject<{
    android: "kotlin";
}> {
    createPlayer(props?: Source, backend?: PlayerBackend, cast?: CastOptions): OmniPlayer;
}
//# sourceMappingURL=omni-player.nitro.d.ts.map